...
public class ActivityB extends Activity implements View.OnClickListener{
    ...
    private ServiceConnection conn = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder binder) {
            ...
            Log.i("buder", "ActivityB - onServiceConnected");
            int num = service.getRandomNumber();
            Log.i("buder", "ActivityB - getRandomNumber = " + num);
        }

        @Override
        public void onServiceDisconnected(ComponentName name) {
            isBind = false;
            Log.i("buder", "ActivityB - onServiceDisconnected");
        }
    };
    ...
    public void onDestroy(){
        super.onDestroy();
        Log.i("buder", "ActivityB - onDestroy");
    }
