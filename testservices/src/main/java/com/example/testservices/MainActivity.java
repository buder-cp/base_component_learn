...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder binder) {
            ...
            Log.i("buder", "ActivityA - onServiceConnected");
            int num = service.getRandomNumber();
            Log.i("buder", "ActivityA - getRandomNumber = " + num);
        }

        @Override
        public void onServiceDisconnected(ComponentName name) {
            isBind = false;
            Log.i("buder", "ActivityA - onServiceDisconnected");
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("buder", "ActivityA - onCreate - Thread = " + Thread.currentThread().getName());
    ...
    protected void onDestroy() {
        super.onDestroy();
        Log.i("buder", "ActivityA - onDestroy");
    }
}
