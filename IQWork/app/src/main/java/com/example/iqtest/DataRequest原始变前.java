...
public class DataRequest原始变前 {
    ...
    static void doPost() {
        ...
        sb.append(mac).append(deviceChip).append(deviceModel).append(SECRET_KEY)
                .append(timestamp).append(COMMOND).append(pageId).append(pageNo)
                .append(version);
        ...
        String url = "http://launcher.chsmarttv.com/chtest/launcher/v4/getRecommendData/iqiyi?" + result;
