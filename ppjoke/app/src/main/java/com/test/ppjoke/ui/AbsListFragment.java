...
import com.test.libcommon.view.EmptyView;
import com.test.ppjoke.R;
import com.test.ppjoke.databinding.LayoutRefreshViewBinding;
...
public abstract class AbsListFragment<T>/*<T, M extends AbsViewModel<T>>*/ extends Fragment implements OnRefreshListener, OnLoadMoreListener {
