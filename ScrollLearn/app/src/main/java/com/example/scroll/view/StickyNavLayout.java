...
public class StickyNavLayout extends LinearLayout implements NestedScrollingParent {
    ...
    /**
     * 子View开始滚动时，请求父View是否开始接受嵌套滚动，返回true表示接受，false反之，
     * child是直接的子View，target是产生嵌套滚动的View,axes表示方向，垂直或者左右
     * true：则子view滚动完后，父view开始滚动；
     * false：则只有子view滚动，完后父view不会滚动
     */
    @Override
    ...
    //同上 onStartNestedScroll
    @Override
    public void onNestedScrollAccepted(@NonNull View child, @NonNull View target, int nestedScrollAxes) {
        Log.e(TAG, "onNestedScrollAccepted");
    }

    //停止嵌套滚动的操作的回调方法，target是产生嵌套滚动的View
    @Override
    ...
    /**
     * 目标视图嵌套滚到后回调的方法，dxConsumed，dyConsumed表示已经消耗的滚动距离，
     * dxUnconsumed, dyUnconsumed表示未消耗的滚动视图
     */
    @Override
    ...
    //目标target视图执行嵌套滚动前的回调，dx,dy 为产生的滚动距离，consumed 为父View消耗的滚动距离
    //通过回调onNestedPreScroll方法告知parent当前滑动的距离
    ...
    //目标视图执行fling事件的回调前的回调，返回true表示父View消耗了fling事件
    @Override
